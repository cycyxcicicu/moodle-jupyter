...
1. **GitLab CE** (Port HTTP: `18088`, SSH: `2424`): Hệ thống quản lý mã nguồn.
...
*   **GitLab Web UI**: [http://gitlab.school.local:18088](http://gitlab.school.local:18088)
    *   **Username**: `root`
    *   **Password**: Lấy giá trị cấu hình của `GITLAB_ROOT_PASSWORD` trong file `.env` (mặc định là `SuperSecretPassword123!`).
...
## Bước Tiếp Theo: Cấp phát bài làm tự động (CI/CD)

Để tự động tạo repository, phân quyền và cấp phát bài làm mẫu cho sinh viên trên GitLab, bạn hãy sử dụng công cụ Provisioning.

👉 Xem hướng dẫn chi tiết tại: [tools/repo-provisioning/README.md](file:///wsl.localhost/Ubuntu/home/huynhduc/e-learning-huce/moodle-jupyter-platform/tools/repo-provisioning/README.md)
